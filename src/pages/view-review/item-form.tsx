...
const formSchema = z
  ...
  .refine((data) => data.videoUrl || data.file?.[0], {
...
export function ItemForm({ onSuccess, onCancel }: ItemFormProps) {
  ...
  const { mutate: addVideoReview, isPending: isAddPending } =
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      formData.append("package", params.id as string);
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-end space-x-4 pt-4">
            <Button
              ...
              variant="outline"
              onClick={onCancel}
              disabled={isAddPending || isUploading}
            >
              Cancel
            </Button>
            <Button type="submit" disabled={isAddPending || isUploading}>
              {isAddPending ? (
                <>
