...
import { UploadHomeGalleryModal } from "./UploadHomeGalleryModal";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { HomeGalleryViewModal } from "./HomeGalleryViewModal";
...
const HomeGallery = () => {
  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      if (isEdit && editingImage) {
        ...
        await api.put(`/homegallery/${editingImage.id}`, formData, {
          headers: {
        ...
        // Upload new image
        await api.post(`/homegallery`, formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        });
  ...
  const handleEdit = (image: HomeGalleryType) => {
    setEditingImage({
      id: image._id,
