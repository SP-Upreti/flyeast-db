...
function LoginNotificationBell({ onClick, showFailedOnly = true }: LoginNotificationBellProps) {
    ...
    return (
        <Button
            ...
            size="icon"
            onClick={onClick}
            className={`relative rounded-full bg-zinc-50 hover:bg-zinc-50 cursor-pointer border hover:border-red-500 ${hasFailedAttempts ? 'border-red-200 bg-red-50 hover:bg-red-100' : ''
                }`}
