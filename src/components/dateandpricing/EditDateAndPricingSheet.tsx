  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Failed to fetch date and pricing:", error.message);
      }
    };
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      await updateDateAndPrice(payload, {
        ...
        onError: (error: any) => {
          console.error("Failed to update date and pricing:", error.message);
          toast.error(error.message || "Failed to update date and pricing");
        },
      });
    } catch (error: any) {
      console.error("Error updating date and pricing:", error.message);
