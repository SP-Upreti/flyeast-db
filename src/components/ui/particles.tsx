...
const vertexShader = /* glsl */ `
  ...
  void main() {
    ...
    // FIXED: Use particle's unique random value for timing
    float pulseTime = uTime + random.x * 10.0;
    vPulse = sin(pulseTime * 2.0) * 0.5 + 0.5;
...
export const Component: FC<ComponentProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative w-full z-[45] h-full overflow-hidden animate--blink ${className || ""
        }`}
