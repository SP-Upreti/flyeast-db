        ...
        <div className="space-y-6">
          ...
          {trip.message && (
            <div>
              ...
              <div className="bg-gray-50 p-4 rounded-sm border-l-4 border-red-500">
          ...
          <div className="flex gap-2">
            <a
              ...
              className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-red-600 rounded-[2px] hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
            >
