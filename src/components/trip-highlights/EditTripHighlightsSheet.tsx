...
export default function EditItinerarySheet({ id }: { id: string }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put(`/highlights/${id}`, formDataToSend, {
        headers: {
  ...
  return (
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader>
          <SheetTitle>Edit Trip Highlight</SheetTitle>
          <SheetDescription>
            Edit trip highlight for this package
          </SheetDescription>
        </SheetHeader>
