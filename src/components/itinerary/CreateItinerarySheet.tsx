...
import { useCreateItinerary } from "@/hooks/useItenary";
...
export default function CreateItinerarySheet({
  id,
  onClose,
  ...
  const { mutateAsync: createItenary, isPending: isUpdating } =
    useCreateItinerary();
  ...
  return (
    <div className="w-full p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold">Create Itinerary</h1>
          <p className="text-sm text-muted-foreground">
            Add new itinerary details
          </p>
        </div>
        ...
        <div className="grid h-full gap-2">
          ...
          <div className="h-full w-full">
            <RichTextEditor
              ...
              className="min-h-20 w-full rounded-[2px] border border-gray-300 px-3 py-2 text-sm shadow-sm resize-y focus:outline-none focus:ring-2 focus:ring-red-500"
